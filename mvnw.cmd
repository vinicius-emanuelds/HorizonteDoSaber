...
for /F "usebackq delims=" %%a in ("%MAVEN_PROJECTBASEDIR%\.mvn\jvm.config") do set MACRO_JVM_CONFIG_PARSED_OPTS=!MACRO_JVM_CONFIG_PARSED_OPTS! %%a
@endlocal & set MAVEN_OPTS=%MACRO_JVM_CONFIG_PARSED_OPTS% %MAVEN_OPTS%
...
IF NOT %WRAPPER_SHA_256_SUM%=="" (
    powershell -Command "&{"^
       ...
       "  Write-Output 'Error: SHA-256 mismatches for default wrapper jar.';"^
       "  Write-Output '  Specficied : %WRAPPER_SHA_256_SUM%';"^
       "  Write-Output '  Found      : ' $hash;"^
       "  Write-Error 'SHA-256 mismatches for default wrapper jar.';"^
       "}"^
       "}"
